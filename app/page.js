...
const Home = () => {
  return (
    <>
      ...
      <div className="flex justify-center flex-col items-center -mt-32 max-sm:-mt-96">
      ...
      <div className="p-4 mt-48 flex flex-col justify-center items-center gap-4 w-full">
        <h1 className="sm:text-6xl text-4xl p-2 font-bold tracking-tighter text-neutral-800 drop-shadow-xl flex justify-center items-center gap-4">
