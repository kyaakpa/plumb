...
"
        >
          <div className="flex justify-center flex-col gap-3 w-[800px]">
            <h1 className="text-7xl font-bold max-lg:pl-8 pt-8 text-gray-100">
              Rebates
            </h1>
            <h4 className="text-2xl max-lg:pl-8 py-4 text-gray-100">
            ...
            <p className="mt-12 self-start text-gray-100">
