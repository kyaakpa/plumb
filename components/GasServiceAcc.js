...
const GasServiceAcc = () => {
    const item1 = "Oil to gas burner conversions involve replacing an existing oil-based heating system with a more energy-efficient natural gas system. This conversion is a popular choice for homeowners and businesses looking to reduce heating costs and environmental impact. During the conversion,the oil burner and related components are removed, and a new gas burner is installed. Necessary adjustments are made to the fuel delivery system and combustion controls. This transition not only reduces fuel expenses but often results in cleaner and more efficient heating."
  return (
    <Accordion
